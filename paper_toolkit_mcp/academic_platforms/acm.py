...
unless the ``paper_toolkit_mcp_ACM_API_KEY`` (or legacy ``ACM_API_KEY``)
...
Enable usage::
    ...
    export paper_toolkit_mcp_ACM_API_KEY=<your_acm_api_key>
...
_NOT_CONFIGURED_MSG = (
    "ACM Digital Library is not configured.  Set paper_toolkit_mcp_ACM_API_KEY "
...
class ACMSearcher(PaperSource):
    ...
    Instantiating this class without ``paper_toolkit_mcp_ACM_API_KEY``
    ...
    def __init__(self) -> None:
        ...
        if not self.api_key:
            logger.warning(
                "ACMSearcher initialised without paper_toolkit_mcp_ACM_API_KEY/ACM_API_KEY.  "
