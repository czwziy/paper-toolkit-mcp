...
unless the ``paper_toolkit_mcp_IEEE_API_KEY`` (or legacy ``IEEE_API_KEY``)
...
Enable usage::
    ...
    export paper_toolkit_mcp_IEEE_API_KEY=<your_ieee_api_key>
"""
...
_NOT_CONFIGURED_MSG = (
    "IEEE Xplore is not configured.  Set paper_toolkit_mcp_IEEE_API_KEY "
...
class IEEESearcher(PaperSource):
    ...
    Instantiating this class without ``paper_toolkit_mcp_IEEE_API_KEY``
    ...
    def __init__(self) -> None:
        ...
        if not self.api_key:
            logger.warning(
                "IEEESearcher initialised without paper_toolkit_mcp_IEEE_API_KEY/IEEE_API_KEY.  "
    ...
    def search(self, query: str, max_results: int = 10, **kwargs) -> List[Paper]:  # type: ignore[override]
        ...
        raise NotImplementedError(
            ...
            "Contribute at https://github.com/your-repo/paper-toolkit-mcp."
        )
