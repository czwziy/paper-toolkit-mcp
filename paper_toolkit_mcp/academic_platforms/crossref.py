# paper_toolkit_mcp/academic_platforms/crossref.py
import logging
import time
...
class CrossRefSearcher(PaperSource):
    ...
    USER_AGENT = "paper-toolkit-mcp/0.1.3 (https://github.com/Dragonatorul/paper-toolkit-mcp; mailto:paper-toolkit@example.org)"
    ...
    def search(self, query: str, max_results: int = 10, **kwargs) -> list[Paper]:
        ...
        try:
            ...
            params['mailto'] = 'paper-toolkit@example.org'
    ...
    def _parse_crossref_item(self, item: dict[str, Any]) -> Paper | None:
    ...
    def _extract_date(self, item: dict[str, Any], date_field: str) -> datetime | None:
